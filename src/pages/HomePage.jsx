    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="flex flex-row">
                <p className="text-right pl-[5rem] leading-3 font-helvetica w-[700px] text-[7pt] italic">This is a group
                    which has no name because we are not finished being born.
            ...
            <section className="py-24">
                <div className="mb-12 flex items-start justify-between  border-black pb-4">
                    ...
                    <span className="text-sm font-bold pr-[3rem]">{products.length}</span>
                </div>

                <div className="h-24"/>

                <div className="grid grid-cols-1 gap-x-1.5 gap-y-16 pb-20 md:grid-cols-2 lg:grid-cols-3">
